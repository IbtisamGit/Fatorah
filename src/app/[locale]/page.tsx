...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      {/* Dark & Vibrant Hero Section */}
      <section className="relative pt-32 pb-40 overflow-hidden bg-[#022c22]">
        {/* Animated Background Gradients */}
        <div className="absolute top-[-20%] left-[-10%] w-[50%] h-[50%] rounded-full bg-emerald-600/30 blur-[120px] mix-blend-screen pointer-events-none"></div>
        <div className="absolute bottom-[-20%] right-[-10%] w-[50%] h-[50%] rounded-full bg-green-500/20 blur-[120px] mix-blend-screen pointer-events-none"></div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center z-10">
          ...
          <h1 className="text-5xl md:text-7xl font-black tracking-tight text-white mb-6 max-w-5xl mx-auto leading-[1.1] drop-shadow-2xl">
          ...
          <p className="text-xl md:text-2xl text-emerald-100/80 mb-12 max-w-3xl mx-auto leading-relaxed font-medium">
            {t('hero_subtitle')}
          </p>
        ...
        {/* Curved bottom edge */}
        <div className="absolute bottom-0 left-0 right-0 h-16 bg-gray-50 [clip-path:polygon(0_100%,100%_100%,100%_0,50%_100%,0_0)]"></div>
      </section>
